# Series 2.0 - Complete System Overview
...
3. **AI Chatbot** (`backend/chatbot/service.js`)
   ...
   - Suggests Series.so when users mention boredom
...
- Suggests Series.so when user mentions boredom
- Handles text and audio messages
...
### Example Responses
- User: "I'm bored" → "You should check out https://tv.series.so/ - they have some great new series to watch!"
...
- [x] Series.so suggestion in chatbot
...
6. **Response sent** → Via Series API
...
- **Helpful**: Suggests Series.so when relevant
